...
> تحديث معتمد: [المستخدمون والصلاحيات وتأجيل الدفع](11-users-and-permissions.md) يكمل هذا المخطط. الإجمالي الحالي 13 جدول أعمال مع audit_logs؛ الحسابات والصلاحيات من الأساس، والدفع آخر مرحلة برمجية وفق الملف 10.
...
## 7. قاعدة البيانات — 12 جدولاً أساسياً + audit_logs في تحديث الصلاحيات
...
| 10. ضيوف | wildcard TLS/DNS، InvitationPlayer، RSVP | لا draft للعامة، لا أصل نهائي لغير المدفوع |
| 11. انتهاء وتشغيل | Cron يومي، تحقق فوري، monitoring وbackup | حد expires_at لكل المسارات، استعادة worker وبيانات |

| 12. الدفع ثم تحقق الإطلاق | بوابة واحدة وwebhooks وتسوية، ثم اختبار الرحلة الكاملة | لا تكرار دفع ولا تجاوز تجريبي في الإنتاج |

الجدول أعلاه ملخص؛ ترتيب المهام التفصيلي المعتمد في الملف 10 (15 مرحلة). إدارة محدودة للمستخدمين والمكتبة وسجل التدقيق ضمن الإصدار الأول وفق الملف 11.
