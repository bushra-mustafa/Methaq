...
لم تنشأ قاعدة التطوير الرئيسية methaq خلال هذه المهمة. بعد إنشائها وتحديد الاتصال الصحيح في .env، ينفذ php artisan migrate. لا حاجة إلى migrate:fresh على قاعدة التطوير. الجداول الحالية بنيت واختبرت على القاعدة المعزولة فقط.
